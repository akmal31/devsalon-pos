    ...
    <div id="appCapsule">
        <div class="section mt-4">
            <div class="section-heading d-flex justify-content-between align-items-center">
                <h2 class="title">Semua Customer</h2>
            ...
            <input type="text" id="searchInput" class="form-control" placeholder="Cari customer..."> <br>

            <div class="transactions" id="servicesContainer">
                <p class="text-center">
                    <ion-icon name="telescope-outline" style="font-size: 60px;"></ion-icon><br>- Belum ada Customer -
                </p>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <form id="formEditService" class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-2">
                        <label>Phone</label>
                        <input type="number" class="form-control" id="edit_phone" required>
                    </div>

                    <div class="form-group mb-2">
                        <label>Birthday</label>
                        <input type="text" class="form-control" id="edit_birthday" required>
                    </div>
        ...
        <div class="modal-dialog">
            <form id="formAddService" class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-2">
                        <label>Birthday</label>
                        <input type="text" class="form-control" id="add_birthday" required>
                    </div>
                </div>
...
<script>
    ...
    function loadServices(keyword = "") {
        fetch('<?= base_url("customer/searchCustomer") ?>', {
            method: 'POST',
        ...
        .then(data => {
            ...
            if(Array.isArray(data) && data.length > 0){
                            ...
                            <a class="flex-grow-1">
                                <div class="detail">
                                    <div>
                                        ...
                                        <p>${tr.phone}</p>
                                        <p>Jumlah Transaksi : ${tr.total_transaction} transaksi </p>
                                        <p>Transaksi Rupiah : Rp. ${numberWithCommas(tr.total_rupiah)} </p>
                                    </div>
                                </div>
                            </a>
                ...
                html = '<p class="text-center"><ion-icon name="telescope-outline" style="font-size: 60px;"></ion-icon><br>- Belum ada Customer -</p>';
            }
    ...
    document.getElementById("formAddService").addEventListener("submit", function(e){
        ...
        .then(data => {
            if (data.status) {
                showSuccessModal("Customer baru berhasil ditambahkan!");
