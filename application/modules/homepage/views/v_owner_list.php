    ...
    <div id="appCapsule">
        ...
        <div class="section mt-5">
            ...
            <div class="section-heading">
                <h2 class="title">Ringkasan Bulan ini</h2>
            </div>
            <div class="row mt-2">
                <div class="col-6">
                    <div class="stat-box">
                        <div class="">Pemasukan</div>
                        <div class="text-success">Rp. <?= number_format($monthRevenue, 0, ',', '.') ?></div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="stat-box">
                        <div class="">Pengeluaran</div>
                        <div class="text-danger">Rp. <?= number_format($monthExpense, 0, ',', '.') ?></div>
                    </div>
                </div>
            </div>
        </div>
